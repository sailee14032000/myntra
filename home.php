...
<div class="container-fluid pb-5">
	...
	<div class="col-6 h-50 p-5">
	 ...
	 <div class="col-6 h-50 my-auto">
		...
		<p class="main-bold" style="color: black;font-size: 1.5em!important;">Each women has a unique style, we help you to create your every own style becuase you deserve to shine like a star!<br><button type="button" class="btn btn-dark">Customise Now</button></p>
...
<div class="container-fluid pb-5 dark">
	<div class="row dark">
	 <div class="col-6 h-50 p-5 my-auto">
		...
		<p class="main-bold" style="font-size: 1.5em!important;">Search your favourite tops by just uploading image and we will bring the best matching products.<br><button type="button" class="btn btn-light">Check Now</button></p>
